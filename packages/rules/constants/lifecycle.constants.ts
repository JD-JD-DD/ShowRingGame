...
export const STUD_RECOVERY_HOURS = 2;
export const DAM_SHOW_POST_WHELP_COOLDOWN_HOURS = 8 * SHOW_WEEK_HOURS; // 8 weeks

// Reproductive emergency (Stage 2 deterministic rules only)
export const REPRODUCTIVE_EMERGENCY_TRIGGER_RATE = 0.015
export const REPRODUCTIVE_EMERGENCY_RESPONSE_WINDOW_HOURS = 48
export const REPRODUCTIVE_EMERGENCY_TREATMENT_COST = 6000
export const REPRODUCTIVE_EMERGENCY_EXTENDED_RECOVERY_HOURS = 365
export const REPRODUCTIVE_EMERGENCY_RULESET_VERSION = "REPRODUCTIVE_EMERGENCY_V1"
...
export const NEONATAL_PUPPY_DEATH_RATE = 0.03
