...
assert.match(page, /<ManageDogPanel[\s\S]*<CallNameEditor[\s\S]*<RegisterDogNameForm/, "Identity owns the naming controls");
assert.match(page, /kennel=\{[\s\S]*<DogProfileKennelRunMove[\s\S]*<RehomeDogForm/, "Kennel owns Run movement and rehome");
