        ...
        <header className="theme-panel mb-8 rounded-[28px] px-6 py-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <div className="mt-4"><CommunityAuthor kennel={topic.kennel} badges={topic.badges} supporterTier={topic.supporterTier} currentKennelId={actorKennel.id} sourceType={topic.sourceType} /></div>
            </div>
          ...
          {topic.posts.map((post, index) => (
            ...
            >
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                <CommunityAuthor kennel={post.kennel} badges={post.badges} supporterTier={post.supporterTier} currentKennelId={actorKennel.id} sourceType={post.sourceType} />
