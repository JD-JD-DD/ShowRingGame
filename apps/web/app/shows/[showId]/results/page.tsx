        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-7 text-purple-100/75">
              Published placements, judging scores, dogs, and kennels for each
              completed breed block.
            </p>
          </div>
                            ...
                            {block.showResults.map((result) => (
                              ...
                              >
                                <td className="rounded-l-2xl px-3 py-3">
                                  <div className="inline-flex min-w-10 justify-center rounded-full border border-sky-300/25 bg-sky-500/10 px-3 py-1 font-semibold text-sky-100">
                                    {result.placementCode ??
                                      (result.finalRank
                                        ? String(result.finalRank)
                                        : "-")}
                                  </div>
                                </td>
                                ...
                                <td className="px-3 py-3 text-purple-100/75">
                                  ...
                                  {result.isMajor ? " major" : ""}
                                </td>
                                <td className="rounded-r-2xl px-3 py-3 text-purple-100/65">
                                  {formatEpoch(result.publishedAtEpoch)}
                                </td>
                              </tr>
                            ))}
                          </tbody>
