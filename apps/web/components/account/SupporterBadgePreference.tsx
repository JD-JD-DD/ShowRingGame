...
export default function SupporterBadgePreference({ initialValue, previewTier }: { initialValue: boolean; previewTier: SupportPresentationTierValue | null }) {
