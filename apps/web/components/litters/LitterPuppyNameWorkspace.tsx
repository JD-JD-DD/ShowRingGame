              ...
              return (
                <div key={puppy.dogId} className="grid gap-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface-subtle)] p-4 md:grid-cols-2">
                  ...
                  <label className="grid gap-2 text-sm font-semibold">Call name
                    <input type="text" value={draft.callName} maxLength={MAX_CALL_NAME_LENGTH} onChange={(event) => updateDraft(puppy.dogId, "callName", event.target.value)} className="dog-control rounded-xl px-3 py-2 text-sm outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-200" />
                  </label>
                  {puppy.registeredName ? (
                    ...
                    <label className="grid gap-2 text-sm font-semibold">Registered name
                      <input type="text" value={draft.registeredName} maxLength={MAX_REGISTERED_NAME_LENGTH} onChange={(event) => updateDraft(puppy.dogId, "registeredName", event.target.value)} className="dog-control rounded-xl px-3 py-2 text-sm outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-200" />
                    </label>
                  ) : null}
                </div>
              );
